...
def generate_launch_description():
    ...
    #声明一个urdf目录的参数，方便修改
    action_declare_mode_mode_path = launch.actions.DeclareLaunchArgument(
    ...
    # action_load_joint_effort_controller = launch.actions.ExecuteProcess(
    ...
    return launch.LaunchDescription([
        ...
        #         on_exit=[action_load_joint_effort_controller],
        #     )
        # ),
        launch.actions.RegisterEventHandler(
            event_handler=launch.event_handlers.OnProcessExit(
